...
public class MacroNormalizer2 extends AbstractFunctionNormalizer implements IFunctionNormalizer {
	...
	public static void main(String[] args) {
		ProjectParser parser = new ProjectParser(new File("C:\\Users\\viett\\Desktop\\redis-6.2.5\\src"));
		IFunctionNode function = (IFunctionNode) Search.searchNodes(parser.getRootTree(), new FunctionNodeCondition(),
				File.separator + "ACLCheckPasswordHash(unsigned char*,int)").get(0);
	...
	private String replaceMacro() {
		String mcppPath = AbstractSetting.getValue(ISettingv2.MCPP_EXE_PATH); //"C:\\Users\\viett\\Desktop\\mcpp\\bin\\mcpp.exe";//
